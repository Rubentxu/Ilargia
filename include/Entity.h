...
//        std::unordered_set<boost::any> owners;
        ...
        using EntityChanged = std::function<void(const Entity &entity, int index, const IComponent &component)>;
        using ComponentReplaced = std::function<void(const Entity &entity, int index, const IComponent &previousComponent,
